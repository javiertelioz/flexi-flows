...
type NodeConfig struct {
	...
	TaskFunc      string        `json:"taskFunc,omitempty" yaml:"taskFunc,omitempty"` // Mantenemos ambas versiones
...
// ValidationRuleConfig representa una regla de validación en la configuración
